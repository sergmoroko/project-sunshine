...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.temperature_units_key),
                mContext.getString(R.string.default_temperature_units));

        if (unitType.equals(mContext.getString(R.string.imperial_units))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.default_temperature_units))) {
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            final String OPEN_WEATHER_MAP_KEY = "bbfbe8a6c70eec4c4f3bf5b409dae2ba";
